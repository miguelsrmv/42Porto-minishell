...
void						update_oldpwd_location(char *new_dir,
								t_memptr *memptr);

void						update_pwd_location(char *new_dir,
								t_memptr *memptr);

void						cpy_old_vars_skip_position(char **old, char **dest,
								int index_to_skip);
void						cpy_old_vars_add_position_slot(char **old,
								char **dest, int index_to_skip);
...
char						*get_env_value(char **envp, char *key,
								t_memptr *memptr);
void						add_env_value_quotes(char **envp, char *key,
